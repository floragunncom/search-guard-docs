...
The auth token feature is so far only available in the special beta release. It is not available in the normal Search Guard 47.0.0 release. See [here](../_docs_versions/versions_versionmatrix.md) for the download.
