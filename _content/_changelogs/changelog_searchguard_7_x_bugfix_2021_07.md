...
In order to have an Signals scheduler for a tenant, you then need to use the [Signals activate tenant API](https://search-guard.com/docs/latest/elasticsearch-alerting-rest-api-tenant-activate) to explicitly activate a tenant.
