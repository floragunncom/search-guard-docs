...
* [Docs for JWT](https://search-guard.com/docs/latest/json-web-tokens#using-only-certain-sections-of-a-jwt-subject-claim-as-user-name)
* [Docs for OIDC](https://search-guard.com/docs/latest/openid-json-web-keys#using-only-certain-sections-of-a-jwt-subject-claim-as-user-name)
* [Docs for SAML](https://search-guard.com/docs/latest/saml-authentication#using-only-certain-sections-of-a-saml-user-name)
