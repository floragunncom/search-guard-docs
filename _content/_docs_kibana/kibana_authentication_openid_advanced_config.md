...
# Dashboards/Kibana OpenID Connect Advanced Configuration
{: .no_toc}
...
If you want to customize the URL which Dashboards/Kibana will navigate to when the user selects the "Logout" menu item, use the `logout` option.
