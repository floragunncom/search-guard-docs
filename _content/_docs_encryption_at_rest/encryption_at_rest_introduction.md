...
<table>
  ...
  <tr><td colspan=2 style="text-align:center"><a href="https://maven.search-guard.com/search-guard-encryption-at-rest-release/com/floragunn/search-guard-encryption-at-rest/search-guard-encryption-at-rest-ctl/{{ site.enctl }}/search-guard-encryption-at-rest-ctl-{{ site.enctl }}.sh">Encryption at Rest command line tool (enctl)</a></td></tr>
</table>
