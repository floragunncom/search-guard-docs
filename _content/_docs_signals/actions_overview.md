...
layout: docs
edition: community
description: The Alerting for OpenSearch/Elasticsearch plugin supports multiple connectors like email, Slack, PagerDuty, JIRA or webhooks for sending notifications.
---
