...
If you use the certificates generated by the [demo installation script](../_docs_quickstart/demo_installer.md), cd in the `<ES installation directory>/plugins/search-guard-{{site.searchguard.esmajorversion}}/tools/` and execute:
