...
Besides the actual certificates the tool also generated configuration snippets which you can directly copy and paste into your `openearch.yml`/`elasticsearch.yml`.
