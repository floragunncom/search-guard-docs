...
* If your are using [Document- and Field-Level-Security](dlsfls.md), you can also apply more fine grained permissions based on documents and individual fields.  
