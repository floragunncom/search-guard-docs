...
[Kibana multitenancy module on Maven central](http://search.maven.org/#search%7Cgav%7C1%7Cg%3A%22com.floragunn%22%20AND%20a%3A%22dlic-search-guard-module-kibana-multitenancy%22){:target="_blank"} 
...
Download the latest [Search Guard Kibana plugin](https://github.com/floragunncom/search-guard-kibana-plugin/releases){:target="_blank"} matching your Kibana version from github. The plugin supports multi tenancy from v2:

[Search Guard Kibana plugin releases](https://github.com/floragunncom/search-guard-kibana-plugin/releases){:target="_blank"}
...
<p align="center">
<img src="
kibana_select_tenants.png" style="width: 90%" class="md_image"/>
</p>
...
<p align="center">
<img src="
kibana_mt_disabled.png" style="width: 90%" class="md_image"/>
</p>
...
<p align="center">
<img src="
kibana_config_mismatch.png" style="width: 90%" class="md_image"/>
</p>
